...
call s:h("NonText",       {"fg": s:bg, "bg":s:bg})
...
call s:h("LineNr",        {"fg": s:dark_asphalt, "bg": s:bg})
...
highlight SpelunkerSpellBad gui=underline guifg=#ff5458
highlight SpelunkerComplexOrCompoundWord gui=underline guifg=#ff5458
